...
```{r, out.width = "800px", eval=TRUE, echo = FALSE}
knitr::include_graphics("../useR2017_tutorial/slides_tutorial_files/cool_stuff.png")
```


## Papers

Giuseppe Casalicchio, Jakob Bossek, Michel Lang, Dominik Kirchhoff, Pascal Kerschke, Benjamin
Hofner, Heidi Seibold, Joaquin Vanschoren, and Bernd Bischl.    
