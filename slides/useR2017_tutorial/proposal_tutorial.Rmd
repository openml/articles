...
[@Casalicchio2017openml] and show how everyone can easily contribute to and
make use of *OpenML*. At the end of the tutorial we want every attendee to be
able to interact with the platform. We want to accomplish this by working
hands-on.

# Tutorial content

The tutorial will introduce the **OpenML** concept, the web interface of the server and how software
clients communicate with the server. A large part of the tutorial with demonstrate the different
...
R package](http://github.com/mlr-org/mlr) on **OpenML** tasks with very few lines of code, 
and that meta-information for these algorithms is automatically uploaded to the server
database. The last hour of the tutorial will be devoted to construct a demo project together with
the participants to answer a realistic question from machine learning together with **OpenML** and
*R*.
