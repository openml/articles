...
The tutorial will introduce the **OpenML** concept, the web interface of the server and how to interact with it from R scripts. A large part of the tutorial will demonstrate the different
objects and features of the **OpenML** R package. 
Participants will learn how to run dozens of different machine learning algorithms from the [mlr
