...
everyone can easily contribute and make use of *OpenML*. At the end of the
tutorial we want every attendee to be able to interact with the platform.

# Tutorial content
In this tutorial we want to give an introduction to the OpenML platform and the *R*
...
# OpenML at useR!
We believe that many useR! attendees will be interested in *OpenML* for their
work, research and studies. The Open Source philosophy of *R* aligns with 
