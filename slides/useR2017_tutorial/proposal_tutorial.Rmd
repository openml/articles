...
<!-- Bernd: "prediction challenges" ist nicht so gut -->
...
The only pre-requesite required is a very basic understanding of machine
learning and of *R*.
